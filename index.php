...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage"><span class="glyphicon glyphicon-book logo-large"></span></a>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span style="color:#8A2BE2;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -ADMIN</b></span></h4>
      </div>
...
<div class="modal fade" id="login2">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:#8A2BE2;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -TEACHER</b></span></h4>
      </div>
      <div class="modal-body title1">
<div class="row">
<div class="col-md-3"></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:#8A2BE2;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -USER</b></span></h4>
      </div>
...
<div class="modal fade" id="myModal1">
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title title1"><span  style="color:#8A2BE2;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>SIGN UP</b></span></h4>
      </div>
      <div class="modal-body">
...
<div class="form-group">
  ...
  <div class="col-md-6"> 
    <input  type="submit"  style="background: #8A2BE2;" class="sub" value="sign up"  />
  </div>
</div>
</fieldset>
</form>
...
<div id="developers" class="container-fluid text-center bg-grey" style="font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px;">
  <h2>Developers</h2><br>
  <h4>Who are we</h4>
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="images/ig1.jpg" alt="Ishan" width="400" height="300">
        <p><strong>Ishan Girgaokar</strong></p>
        <p>VIT Pune TY Elex A</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="images/uj.jpeg" alt="Utkarsh" width="400" height="300">
        <p><strong>Utkarsh Jakate</strong></p>
        <p>VIT Pune TY Elex A</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="images/sm.jpeg" alt="Sandesh" width="400" height="300">
        <p><strong>Sandesh Manker</strong></p>
        <p>VIT Pune TY Elex B</p>
      </div>
    </div>
  </div><br>
...
<div id="about" class="jumbotron jumbotron-fluid" >
  <div class="row">
    <div class="col-sm-8">
      <h2>About Page</h2>
      <p>Online examination System is conducting a test online to measure the knowledge of the participants on a given topic. In the olden days everybody had to gather in a classroom at the same time to take an exam. With online examination students can do the exam online, in their own time and with their own device, regardless where they life. You online need a browser and internet connection. </p><br>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-signal logo1" style=""></span>
    </div>
  </div>
</div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p style = 'font-size: 15px;'>Contact us and we'll get back to you within 24 hours.</p>
      <p style = 'font-size: 15px;'><span class="glyphicon glyphicon-map-marker"></span> Pune, India</p>
      <p style = 'font-size: 15px;'><span class="glyphicon glyphicon-phone"></span> +91 8329812940 </p>
      <p style = 'font-size: 15px;'><span class="glyphicon glyphicon-envelope"></span> eexam2020@gmail.com</p>
    </div>
...
<footer class="container-fluid text-center">
  ...
  <p style = 'font-family: Montserrat, sans-serif;'>Thank you for visiting us.</p>
</footer>
